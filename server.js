...
app.use(cors({ origin: 'https://seu-usuario.github.io' })); // Substitua pelo seu domínio do GitHub Pages
...
app.post('/create-checkout-session', authenticate, async (req, res) => {
    ...
    try {
        const session = await stripe.checkout.sessions.create({
            ...
            mode: 'subscription',
            success_url: 'https://seu-usuario.github.io/obscure-hosting/success.html',
            cancel_url: 'https://seu-usuario.github.io/obscure-hosting/cancel.html',
